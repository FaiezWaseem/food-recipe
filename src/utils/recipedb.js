const trendingRecipes = [
    {
        ...
        image: require('../assets/images/recipes/spagetti.png'),
        duration: "30 mins",
        serving: 1,
        isBookmark: false,
        category: "Pasta",
        author: {
            profilePic: require('../assets/images/dummy_profiles/profile-pic-1.png'),
            name: "Maria",
        },
        ingredients: [
            {
        ...
        viewers: [
            ...
            {
                id: 2,
                profilePic: require('../assets/images/dummy_profiles/profile-pic-2.png')
            },
            {
                id: 3,
                profilePic: require('../assets/images/dummy_profiles/profile-pic-3.png')
            },
            {
                id: 4,
                profilePic: require('../assets/images/dummy_profiles/profile-pic-3.png')
    ...
    },
    {
        ...
        image: require('../assets/images/recipes/satay.png'),
        duration: "50 mins",
        serving: 10,
        isBookmark: true,
        category: "Local",
        ...
        viewers: [
            {
                id: 1,
                profilePic: require('../assets/images/dummy_profiles/profile-pic-5.png')
            },
            {
                id: 2,
                profilePic: require('../assets/images/dummy_profiles/profile-pic-4.png')
            },
            {
                id: 3,
                profilePic: require('../assets/images/dummy_profiles/profile-pic-1.png')
    ...
    },
    {
        id: 3,
        name: "Sarawak Laksa",
        image: require('../assets/images/recipes/laksa.png'),
        duration: "30 mins",
        serving: 1,
        isBookmark: true,
        category: "Local",
    ...
    },
    {
        id: 4,
        name: "Nasi Lemak",
        image: require('../assets/images/recipes/nasi-lemak.webp'),
        duration: "1 hour",
        serving: 10,
        isBookmark: true,
        category: "Local",
        author: {
            profilePic: require('../assets/images/dummy_profiles/profile-pic-10.png'),
            name: "Ali Baba",
        },
        ingredients: [
            {
